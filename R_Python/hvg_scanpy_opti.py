...
if n_top_genes is not None:
    ...
    print('The {n_top_genes} top genes correspond to a normalized dispersion cutoff of {disp_cut_off}')
    warnings.append('The {n_top_genes} top genes correspond to a normalized dispersion cutoff of {disp_cut_off}')
else:
