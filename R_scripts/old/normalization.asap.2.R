...
if (std_method_name == "log"){ # default []
  ...
  # Need to check that. Not sure it is correct
  # This is correct: but careful about the t(x) since here it's already t(x) ??
  #tpm <- function(matrix, gene.length){
  #x <- matrix / gene.length
